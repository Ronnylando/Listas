    ...
    transition overflow-hidden`,
    {
        variants: {
            variant: {
                none: "",
                default: `
                 border-2 border-solid  border-green-base hover:border-green-dark hover:bg-green-dark/20 checked:hover:border-green-base
    checked:bg-green-base group-hover:checked:border-green-dark group-hover:checked:bg-green-dark 
    
                 `,
            },
            size: {
                md: "w-5 h-5 rouded-sm"
            },
            disabled: {
...
export const inputCheckiconVariants = cva(`
...
export default function InputCheckbox({
    ...
    return (
        <label className={inputCheckboxWrapperVariants({ className })}>
            ...
            <Icon className={inputCheckiconVariants({ size })} svg={CheckIcon} />
